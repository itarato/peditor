...
struct Config {
  ...
  unordered_map<InputStroke, TextEditorAction> keyMapping{
      ...
      {InputStroke::CtrlUp, TextEditorAction::CursorPageUp},
      {InputStroke::CtrlDown, TextEditorAction::CursorPageDown},
      {InputStroke::CtrlLeft, TextEditorAction::CursorWordJumpLeft},
      {InputStroke::CtrlRight, TextEditorAction::CursosWordJumpRight},
      {InputStroke::PageUp, TextEditorAction::ScrollUp},
      {InputStroke::PageDown, TextEditorAction::ScrollDown},
